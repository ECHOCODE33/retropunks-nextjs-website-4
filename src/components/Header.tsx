...
export default function Header() {
  ...
  const arrow = (
    <svg
      className="w-3 h-3 transition-all -translate-x-2 opacity-0 group-hover/item:opacity-40 group-hover/item:translate-x-0"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
  ...
  const dropdownAnchorClass =
    "block w-full px-4 py-2.5 hover:bg-white/5 rounded-xl transition-all group/item";
  ...
  const textWrapperClass =
    "text-sm font-medium text-zinc-300 group-hover/item:text-white transition-colors";
        ...
        <nav className="items-center justify-center flex-1 hidden lg:flex ">
          ...
          <div ref={rootRef} className="relative group">
            ...
            >
              SOCIALS
              <svg
                className={`w-3.5 h-3.5 opacity-60 transition-transform duration-300 ${socialsOpen ? "rotate-180" : "group-hover:rotate-180"}`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <div
              id="socials-menu"
              role="menu"
              aria-hidden={!socialsOpen}
              className={socialsMenuClass}
            >
                ...
                <div>
                  {(() => {
                    ...
                    if (chain.unsupported) {
                      return (
                        <button
                          className="connect-btn bg-error!"
