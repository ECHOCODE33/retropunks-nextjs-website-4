...
export const metadata: Metadata = {
  ...
  description:
    "An exclusive collection of 10,000 retro PFP NFTs on the Ethereum chain. Fully on-chain artwork.",
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${pressFont.variable} ${googleFont.variable} ${robotoFont.variable} ${spaceFont.variable} ${lexendFont.variable} ${oxaniumFont.variable} antialiased`}
    >
      <body>
        <ClientProviders>
